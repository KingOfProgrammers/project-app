                ...
                <Container>
                    ...
                    <Alert variant={props.color.color1} style={{margin : "10px 5px 10px 5px"}}>
                        ...
                        <ButtonGroup vertical size="lg" style={{margin : "10px 5px 10px 5px"}}>
                            <Button variant={props.color.color1} onClick={(e)=>{setShowList([...(MHList.All)]); setfilterTitle("All"); e.preventDefault();}}>همه اساتید</Button>
                            <Button variant={props.color.color1} onClick={(e)=>{setShowList([...(MHList.Pure_Mathematics)]); setfilterTitle("Pure Mathematics"); e.preventDefault();}}>آساتید ریاضی محض</Button>
                            <Button variant={props.color.color1} onClick={(e)=>{setShowList([...(MHList.Applied_Mathematics)]); setfilterTitle("Applied Mathematics"); e.preventDefault();}}>اساتید ریاضی کاربردی</Button>
                            <Button variant={props.color.color1} onClick={(e)=>{setShowList([...(MHList.Computer_science)]); setfilterTitle("Computer science"); e.preventDefault();}}>اساتید علوم کامپیوتر</Button>
                            <Button variant={props.color.color1} onClick={(e)=>{setShowList([...(MHList.Statistics)]); setfilterTitle("Statistics"); e.preventDefault();}}>اساتید آمار</Button>
                        </ButtonGroup>
