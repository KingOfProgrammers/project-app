...
function UserReserveBrowser(props){
                            ...
                            <Row>
                                <Col>
                                    <Stack>
                                        ...
                                        <ButtonGroup vertical >
                                            {showTime.slice(0,24).map((data , index) => (
                                ...
                                <Col>
                                    <Stack>
                                        ...
                                        <ButtonGroup vertical >
                                            {showTime.slice(24,48).map((data , index) => (
                                                <Button onClick={()=>{timeFunction(index+24)}} variant={data == "set" ? props.color.color2 : props.color.color1} disabled={data == "full"} size="sm"> 
                                ...
                                <Col>
                                    <Stack>
                                        ...
                                        <ButtonGroup vertical >
                                            {showTime.slice(48,72).map((data , index) => (
                                ...
                                <Col>
                                    <Stack>
                                        ...
                                        <ButtonGroup vertical >
                                            {showTime.slice(72,96).map((data , index) => (
                                                <Button onClick={()=>{timeFunction(index+72)}} variant={data == "set" ? props.color.color2 : props.color.color1} disabled={data == "full"} size="sm"> 
...
export default UserReserveBrowser;